...
import AppliedApplicants from "@/components/Opportunities/SingleOpportunityView/AppliedApplicants";
import ShortlistedApplicants from "@/components/Opportunities/SingleOpportunityView/ShortlistedApplicants";
import InvitedApplicants from "@/components/Opportunities/SingleOpportunityView/InvitedApplicants";
import AcceptedApplicants from "@/components/Opportunities/SingleOpportunityView/AcceptedApplicants";
import RejectedApplicants from "@/components/Opportunities/SingleOpportunityView/RejectedApplicants";
...
const SingleOppTabs: React.FC<Props> = ({
  ...
  return (
    <>
      <div className="lg:flex hidden border-b border-secondary-elements">
        <button
          className={cn(
            "bg-transparent outline-none focus:outline-none lg:mr-10 lg:w-auto w-full lg:block flex flex-wrap justify-center lg:py-4 py-6",
            {
      ...
      <div className="lg:hidden block border-b border-secondary-elements">
        <Slider {...sliderSetting}>
          ...
          <div className="pr-4">
            <button
              className={cn(
                "text-left bg-transparent outline-none focus:outline-none lg:mr-10 lg:py-4 py-6",
                {
                  "active-tab text-titles": tabs === 2,
                  "text-secondary": tabs > 2 || tabs < 2,
                }
